...
template = """
You are an assistant for question-answering tasks regarding quitting smoking. Use the following pieces of retrieved context to answer the question. If you don't know the answer, just say that you don't know.
Question: {question} 
Context: {context} 
Answer:
"""
